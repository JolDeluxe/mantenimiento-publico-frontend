  ...
  return (
    <header className="bg-transparent px-4 py-3 relative">
      <div className="flex items-center justify-between">
        ...
        {/* DERECHA: Solo Campana de Notificaciones */}
        <div className="flex items-center">
          <button
            onClick={() => navigate(`/notificaciones?refresh=${Date.now()}`)}
            className="relative p-2 rounded-xl hover:bg-white/20 active:scale-95 transition-all text-marca-primario outline-none border border-transparent hover:border-white/30"
