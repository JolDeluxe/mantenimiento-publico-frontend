...
export const WelcomeMobile = () => {
  ...
  return (
    <div className="relative flex flex-col min-h-full bg-slate-50/50 pb-8 animate-in fade-in duration-300">
      ...
      >
        ...
        <div className="overflow-hidden bg-white border border-slate-200/70 rounded-3xl shadow-[0_10px_30px_rgba(15,23,42,0.10)] relative">

          {/* Área visual con imagen */}
          <div className="relative min-h-[230px] sm:min-h-[250px] overflow-hidden">
            ...
            {/* Contenido */}
            <div className="relative z-10 flex flex-col gap-2 p-5 max-w-[88%] sm:max-w-[72%]">
              <span className="px-2.5 py-1 rounded-full bg-black/25 text-white font-extrabold text-[8px] uppercase tracking-widest w-fit border border-white/20 shadow-sm flex items-center gap-1">
                <Icon name="qr_code_scanner" className="text-[10px]" />
                <span>CUADRA Mantenimientos</span>
              </span>

              <h2 className="text-xl font-black tracking-tight leading-[1.1] text-white drop-shadow-md">
                ¿Cómo podemos ayudarte hoy?
              </h2>

              <p className="text-[11px] text-white/95 leading-relaxed font-medium drop-shadow-sm">
          ...
          <div className="relative z-10 bg-[#66494a]/75 backdrop-blur-xl p-3.5 border-t border-white/10 rounded-b-3xl shadow-[inset_0_1px_0_rgba(255,255,255,0.15)]">

            {/* Acción principal (Compactado a 48px, Cristal Claro con Texto en Acento) */}
            <button
              onClick={handleStartReport}
              className="w-full min-h-[48px] sm:min-h-[50px] px-4 py-2 bg-white/80 backdrop-blur-xl border border-white/60 text-[#66494a] hover:bg-white/90 font-bold text-[10.5px] uppercase tracking-wider rounded-2xl shadow-[0_8px_24px_rgba(102,73,74,0.3),inset_0_1px_0_rgba(255,255,255,0.85)] active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-[#66494a]/50 relative overflow-hidden"
            >
            ...
            <div className="grid grid-cols-1 min-[340px]:grid-cols-2 gap-2 mt-2">
              <button
                onClick={handleGoToActive}
                aria-label="Ver reportes activos"
                className="min-h-[46px] sm:min-h-[48px] px-3 py-2 bg-[#846768]/25 backdrop-blur-xl border border-white/20 text-[#F0EBE9] hover:bg-[#846768]/35 font-bold text-[10.5px] transition-all active:scale-[0.98] flex items-center justify-center gap-2 cursor-pointer rounded-2xl shadow-[0_8px_20px_rgba(102,73,74,0.15),inset_0_1px_0_rgba(255,255,255,0.12)] outline-none relative overflow-hidden"
              >
        ...
        <div className="flex flex-col gap-2.5">
          ...
          <div className="grid grid-cols-1 min-[340px]:grid-cols-3 gap-2.5 w-full">
            
            {/* Paso 1 - Reporta */}
            <div className="flex flex-col items-center text-center bg-white/45 backdrop-blur-xl border border-white/45 rounded-2xl p-3 shadow-[0_8px_30px_rgba(0,0,0,0.015)] h-full justify-start min-h-[110px]">
