  ...
  return (
    <div className="flex flex-col items-center text-center animate-in fade-in zoom-in duration-300">
      ...
      <p className="text-slate-600 text-sm mb-6 leading-relaxed">
        ...
        <br/><br/>
        Si registraste tu cuenta sin correo institucional, o necesitas recuperar tu contraseña, favor de contactar a tu coordinador o al equipo de Procesos Tecnológicos:
        <br/>
